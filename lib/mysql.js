...
MySQL.prototype.retrieveActiveLoadBalancers = function (activeThreshold,
  ...
  this.connection.query(
    "select * from parent_load_balancers p where ? > (select count(*) from load_balancer_nodes n where p.load_balancer_id = n.parent_load_balancer_id and n.load_balancer_id is not null)",
    [activeThreshold],
    results_callback
  );
};
